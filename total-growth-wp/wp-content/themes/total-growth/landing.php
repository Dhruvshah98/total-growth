        ...
        <div class="swiper testiSwiper testi-swiper">
          ...
          <div class="testi-nav-wrap">
            <div class="testi-swiper-prev">
              <img src="<?php bloginfo('template_url'); ?>/assets/img/testi-prev.svg" alt="click to previous" width="100%" height="100%" loading="lazy" />
            </div>
            <div class="testi-swiper-next">
              <img src="<?php bloginfo('template_url'); ?>/assets/img/testi-next.svg" alt="click to previous" width="100%" height="100%" loading="lazy" />
            </div>
          </div>
        </div>
      </div>
